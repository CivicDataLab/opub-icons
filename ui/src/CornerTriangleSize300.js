...
export default function CornerTriangleSize300(props) {
  return (
    <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" width={7} height={7} viewBox="0 0 7 7" {...props}>
