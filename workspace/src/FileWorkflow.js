...
export function FileWorkflow(props) {
	return (
		<svg
		...
		>
			...
			<path d="M7.75,16.75v-4.5a1.5,1.5,0,0,1,1.5-1.5h4.586A1.49551,1.49551,0,0,1,15,9.7895V7H9.5A.5.5,0,0,1,9,6.5V1H3.5a.5.5,0,0,0-.5.5v15a.5.5,0,0,0,.5.5H7.7755A1.456,1.456,0,0,1,7.75,16.75Z" />
		</svg>
	)
}
