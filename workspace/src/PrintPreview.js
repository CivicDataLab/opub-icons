...
export function PrintPreview(props) {
	return (
		...
		>
			...
			<polygon points="5 1 5 5 1 5 5 1" />
			<path d="M5.85,11.5A5.65,5.65,0,0,1,11.5,5.85c.169,0,.335.0105.5.025V1.5a.5.5,0,0,0-.5-.5H6V5.5a.5.5,0,0,1-.5.5H1v7.5a.5.5,0,0,0,.5.5H6.439A5.61442,5.61442,0,0,1,5.85,11.5Z" />
